 ...
 *   scriptProperties.setProperty('WIX_SITE_ID', '<YOUR_WIX_SITE_ID>');
 *   // Then invoke:
...
function test(){
  populateWixEventFromLumaUrl("https://grok.com/chat/548e9785-f014-4458-a82f-5f59727a25c7?referrer=website");
}