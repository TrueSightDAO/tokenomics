...
var CLASP_MIRROR_LAST_CLASP_PUSH_UTC = '2026-05-25T20:45:52Z';

/**
 * Newest first. Keep lines short; link PRs/commits in git instead of pasting secrets.
 */
var CLASP_MIRROR_CHANGELOG =
  '2026-05-25 — QR reader web service: newsletter opt-in — when &subscribe=true, also append email to "Agroverse News Letter Subscribers" (Source=qr:<code>).\n' +
