...
var CLASP_MIRROR_LAST_CLASP_PUSH_UTC = '2026-06-03T22:30:00Z';

/**
 * Newest first. Keep lines short; link PRs/commits in git instead of pasting secrets.
 */
var CLASP_MIRROR_CHANGELOG =
  '2026-06-03 — applyHitListAuAvFormulasToRow_: fix getRange args (rowNum, HIT_LIST_COL_AU, 1, 2). Was passing rowNum as numRows and HIT_LIST_COL_AV as numColumns, causing "data has 1 but range has N" on every addNewStore + field-report status update (PR: dapp_beta#38 / tokenomics fix).\n' +
