...
const SOLD_DATE_COL_DEST = 26; // Column AA (Sold Date) — moved off column W (2026-08-20): live sheet col W is 'Review Email Sent Date' (review workflow), so the stamp must not land there. AA is a free column (grid max 28).
