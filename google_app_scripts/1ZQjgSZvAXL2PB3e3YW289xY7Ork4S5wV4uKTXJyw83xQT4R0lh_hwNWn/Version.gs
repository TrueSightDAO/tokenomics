...
var CLASP_MIRROR_LAST_CLASP_PUSH_UTC = '2026-07-15T18:41:55Z';

/**
 * Newest first. Keep lines short; link PRs/commits in git instead of pasting secrets.
 */
var CLASP_MIRROR_CHANGELOG =
  '2026-07-15 — Full Wix removal: setDailyTdgBuyBackBudget/updateTotalDAOAssetOnWix/setTDGIssuedOnWix/update30DaysSalesOnWix/setUSTreasuryYieldOnWix/updateAssetPerIssuedTdg now compute locally + write Performance Statistics directly (no wixapis.com calls). Fixes "Attribute provided with invalid value: Header:null" cron failures (wixAccessToken was null — WIX_API_KEY script property gone). Deleted getWixRequestHeader/getWixDataCollectionId/getWix*DataItemId + 2 fully dead read-only Wix functions. Names kept for trigger continuity.\n' +
