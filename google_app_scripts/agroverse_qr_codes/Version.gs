...
var AGROVERSE_QR_GENERATION_LAST_CLASP_PUSH_UTC = '2026-06-12T00:00:00Z';

/**
 * Newest first. Keep lines short; link PRs/commits in git instead of pasting secrets.
 */
var AGROVERSE_QR_GENERATION_CHANGELOG =
  '2026-06-12 — Add register_single_qr_code.gs: doGet ?action=registerSingleQRCode for single QR registration (Phase 1).\n' +
