 ...
 * Used for authorization bypass: governor-reported expenses are always authorized.
 */
function isGovernorByName_(contributorName) {
  if (!contributorName) return false;
  try {
    var spreadsheet = SpreadsheetApp.openByUrl(OFFCHAIN_TRANSACTIONS_SHEET_URL);
