...
var CLASP_MIRROR_LAST_CLASP_PUSH_UTC = '2026-04-22T12:00:00Z';

/**
 * Newest first. Keep lines short; link PRs/commits in git instead of pasting secrets.
 */
var CLASP_MIRROR_CHANGELOG =
  '2026-04-22 — Scored Expense Submissions column N Processing Status (authorized|unauthorized); skip ledger when unauthorized; Governor YES or reporter=DAO Member.\n' +
